...
<div class="register-box">
  <div class="register-logo">
    <a hreff="<?php echo base_url()?>asset/index2.html"><b>Admin</b>LTE</a>
  </div>
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="<?php echo base_url('auth/registration') ?>" method="post">
        ...
        <?php echo form_error('name', '<small class="text-danger" style="position: relative; top: -20px">','</small>'); ?>
        <div class="input-group mb-3">
        ...
        <?php echo form_error('email', '<small class="text-danger" style="position: relative; top: -20px">','</small>'); ?>
        <div class="input-group mb-3">
        ...
        <?php echo form_error('password1', '<small class="text-danger" style="position: relative; top: -20px">','</small>'); ?>
        <div class="row">
          <div class="col-8">
          </div>
          <!-- /.col -->
